...
class BrokerFishType extends Model
{
    use HasFactory;

    protected $table = 'broker_fish_type';
    ...
    {
        return $this->hasMany(FishPrice::class, 'broker_fish_type_id');
    }
    ...
    {
        return $this->hasOne(FishPrice::class, 'broker_fish_type_id')->latestOfMany();
    }
}
