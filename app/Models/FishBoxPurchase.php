...
class FishBoxPurchase extends Model
{
    use HasFactory;
    ...
    {
        return $this->hasMany(InventoryLog::class, 'fish_box_purchase_id');
    }
    ...
    {
        return $this->hasMany(SalesDetails::class, 'fish_box_purchase_id');
    }
    ...
    public static function createForBox(
        ...
        InventoryLog::createLogForPurchase(
            $purchase->id,
