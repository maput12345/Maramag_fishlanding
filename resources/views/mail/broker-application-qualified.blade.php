...
<p><strong>Bidding Date:</strong> {{ optional($opening->bidding_date ?? $opening->start_date)->format('F j, Y') ?? 'To be announced' }}</p>
<p><strong>Bidding Time:</strong> {{ optional($opening->bidding_time)->format('h:i A') ?? 'To be announced' }}</p>
