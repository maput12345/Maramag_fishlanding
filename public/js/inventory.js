...
document.addEventListener('DOMContentLoaded', function () {
  ...
  confirmableForms.forEach(function (form) {
    form.addEventListener('submit', function (e) {
      ...
      var recordName = getRecordNameFromForm(form);
      switch (action) {
        case 'delete':
        ...
        case 'deactivate':
          ...
          confirmText = "Yes, deactivate ".concat(recordType.toLowerCase());
          break;
        case 'activate':
...
function getRecordNameFromForm(form) {
  ...
  var dataName = form.getAttribute('data-record-name');
  if (dataName) {
    return dataName;
  }
  ...
  if (tableRow) {
    ...
    var nameCell = tableRow.querySelector('td:first-child .text-sm.font-medium, td:first-child .font-medium');
    if (nameCell) {
  ...
  var nameInput = form.querySelector('input[name="name"], input[name="record_name"]');
  if (nameInput) {
